        ...
        try:
            ...
            for idx, series in enumerate(all_series):
                ...
                try:
                    ...
                    self.progress.emit(
                        f'Warning: failed episode files for "{title}": {e}'
                    )
                    series_failed = True
                    ep_files = []
                ...
                for ef in ep_files:
                    ...
                    season_num = (
                        eps_for_file[0].get("seasonNumber", 0) if eps_for_file else 0
                    )
                    ep_num = (
                        eps_for_file[0].get("episodeNumber", 0) if eps_for_file else 0
                    )
